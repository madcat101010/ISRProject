...
spark-submit --master local --driver-memory 5G --jars jarlib/stanford-english-corenlp-3.8.0-models.jar,jarlib/stanford-corenlp-3.8.0.jar,jarlib/hbase-rdd_2.11-0.8.0.jar --class isr.project.SparkGrep target/scala-2.10/sparkgrep_2.10-1.0.jar "label" "tweet" "getar-cs5604f17-solar-eclipse-001" "eclipsedatasample1_cla" "solareclipse" "SolarEclipse" "NotSolarEclipse"
